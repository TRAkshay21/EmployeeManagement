...
<%@ include file="employeeHeading.html" %>
     ...
     <h1>Apply Leave </h1>
<form class="mt-3" action="InsertEmployeeLeave.in">
  <div class="form-group">
  
   <!--  <input type="text" class="form-control" name="empid" id="empid"  placeholder="Employee Id"/> -->
 
    <label for="fromdate">From Date:</label>
    <input type="date" class="form-control" name="fromdate" id="fromdate" required="required"/>
 
    <label for="todate">To Date:</label>
    <input type="date" class="form-control"  name="todate" id="todate" required="required"/>
 
    <label for="textarea">Reason</label>
    <textarea class="form-control" id="textarea" name="textarea" required="required"></textarea>
